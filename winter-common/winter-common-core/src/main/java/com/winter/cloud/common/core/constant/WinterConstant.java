package com.winter.cloud.common.core.constant;
 ...
 * @author MrBird
 */
public interface WinterConstant {
     ...
     * Gateway请求头TOKEN值
     */
    String GATEWAY_TOKEN_VALUE = "winter:gateway:0518";
     ...
     * 验证码 key前缀
     */
    String CODE_PREFIX = "winter.captcha.";

    /**
     * 异步线程池名称
     */
    String ASYNC_POOL = "winterAsyncThreadPool";
