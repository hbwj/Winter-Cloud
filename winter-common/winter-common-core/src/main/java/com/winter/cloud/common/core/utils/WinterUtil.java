...
import com.winter.cloud.common.core.constant.PageConstant;
import com.winter.cloud.common.core.constant.RegexpConstant;
import com.winter.cloud.common.core.constant.StringConstant;
import com.winter.cloud.common.core.entity.CurrentUser;
import com.winter.cloud.common.core.entity.WinterAuthUser;
...
public class WinterUtil {
    ...
    public static String getCurrentUsername() {
        ...
        if (principal instanceof WinterAuthUser) {
            return ((WinterAuthUser) principal).getUsername();
        }
