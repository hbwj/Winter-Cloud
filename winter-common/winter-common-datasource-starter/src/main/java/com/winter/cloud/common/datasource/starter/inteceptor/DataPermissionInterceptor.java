package com.winter.cloud.common.datasource.starter.inteceptor;
...
import com.winter.cloud.common.datasource.starter.annotation.DataPermission;
...
public class DataPermissionInterceptor extends AbstractSqlParserHandler implements Interceptor {
    ...
    private String dataPermissionSql(String originSql, DataPermission dataPermission) {
        try {
            ...
            CurrentUser user = WinterUtil.getCurrentUser();
            if (user == null) {
                return originSql;
            }
