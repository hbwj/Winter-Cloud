package com.winter.cloud.common.doc.gateway.handler;
...
@RestController
public class WinterSwaggerHandler {

    private SecurityConfiguration securityConfiguration;
    private UiConfiguration uiConfiguration;
    private SwaggerResourcesProvider swaggerResourcesProvider;
    private WinterDocGatewayProperties properties;
    ...
    public void setSwaggerResourcesProvider(SwaggerResourcesProvider swaggerResourcesProvider) {
        this.swaggerResourcesProvider = swaggerResourcesProvider;
    }

    public void setProperties(WinterDocGatewayProperties properties) {
